...
class CharacterTree:
    ...
    def get_all_translations(self, language_array_shortenings):
        lifo_stack = []
    ...
    def parse(self, lifo_stack, dictionary_base, language_array_shortenings):
        ...
        for character, dictionary in dictionary_base.items():
            if character in language_array_shortenings:
                ...
                print(word +" -> "+ dictionary + " ("+character+")")
            else:
...
sk_tree.init('sk')
#sk_tree.load_as_json('sk_test_character_tree.json','sk')
sk_tree.load_as_json('dataResultAll.txt','sk')
sk_tree.get_all_translations(['cs', 'en'])
